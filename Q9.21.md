...
After PCA, since the principal components are orthogonal, there is no correlation whatsoever. The correlation plot is perfectly white,apart from autocorrelation.
...
$$1.49522708, 1.25541470, 0.43197934, 0.04029573$$
...
One of the methods that can be used is to assess the best number of principal components based on accuracy measures - RMSEP, MSEP and R2.

From plots below it is visible that for all measures, the point where the change is most dramatic is 8. This is the desired number of principal components.
